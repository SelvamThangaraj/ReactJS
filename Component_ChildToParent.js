  ...
  updateSalary=()=>{
    ...
    render(){
      return <div>
        ...
        <p>
          <label>Basic Salary :<input type="text" refs="BasicSalary" defaultValue={this.state.basic} ref="BasicSalary" /></label>
        </p>
        <p>
          <label>HRA : <input type="text" refs="HRA" defaultValue={this.state.hra} ref="HRA" /></label>
        </p>
        <p>
          <label>Special Allowance : <input type="text" refs="SpecialAllowance" defaultValue={this.state.sa} ref="SpecialAllowance" /></label>
        </p>
